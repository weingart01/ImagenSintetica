 ...
 */
#ifndef INC_VECTOR_TEMPLATE_H_
#define INC_VECTOR_TEMPLATE_H_
...
struct T_VECTOR3
{
	...
	//return a vector where each component is multiplied by b
	const T_VECTOR3 filter( const T_VECTOR3& b ) const
	{
		return T_VECTOR3( x*b.x, y*b.y, z*b.z );
	}
...
struct T_VECTOR4
{
	...
	//unit vector
	const struct T_VECTOR4 unit() const
	{
		return (*this) / this->length();
	}
